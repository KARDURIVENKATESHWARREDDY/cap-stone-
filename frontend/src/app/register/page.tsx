...
import { Lock, Mail, User, AlertTriangle, Eye, EyeOff, Loader2 } from "lucide-react";
...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const message = err instanceof Error ? err.message : "Registration failed. Email might already be taken.";
            setError(message);
            setLoading(false);
        }
    };
    ...
    return (
        <div className="min-h-screen bg-[#090d16] animated-bg-gradient flex flex-col items-center justify-center p-6 select-none">
            ...
            <div className="w-full max-w-md p-8 rounded-2xl border border-slate-800 bg-[#0b1329]/95 backdrop-blur-md shadow-2xl relative overflow-hidden">
                ...
                <p className="text-xs text-slate-400 mb-6">Initialize a developer workspace profile</p>
